...
type DateTimePickerProps = {
  ...
  granularity?: Granularity;
  /**
   * The className prop allows you to control the DateTimePicker style.
...
const DateTimePicker = React.forwardRef<DateTimePickerRef, DateTimePickerProps>(
  (
    ...
    const handleSelect = (newDay: Date | undefined) => {
      ...
      if (value) {
        newDay.setHours(value.getHours());
        newDay.setMinutes(value.getMinutes());
        newDay.setSeconds(value.getSeconds());
      }
